...
\begin{frame}[fragile]
  ...
  Workshop de LaTeX no \mintinline{latex}{\scielo{}} em junho.
\end{frame}
...
\begin{frame}
  ...
  \LARGE
  Macros como \mintinline{latex}{\maketitle} usam variáveis como
...
\begin{frame}
  ...
  \LARGE
  \mintinline{latex}{\makeatletter … \makeatother}
\end{frame}
...
\begin{frame}
  ...
  \LARGE
  Veremos como customizar o \mintinline{latex}{\maketitle} usando o comando
  \mintinline{latex}{\renewcommand{\maketitle}{…}}
\end{frame}
...
\begin{frame}
  ...
  \LARGE
  Macros podem levar argumentos: \mintinline{latex}{\textbf{texto}}
\end{frame}
